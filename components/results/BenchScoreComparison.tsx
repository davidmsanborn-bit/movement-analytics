import { compareBenchAnalysis } from "@/lib/analysis/compareBench";
...
export function BenchScoreComparison({ previous, current }: Props) {
  const cmp = compareBenchAnalysis(previous, current);
