import { compareShootingAnalysis } from "@/lib/analysis/compareShootingAnalysis";
...
export function ShootingScoreComparison({ previous, current }: Props) {
  const cmp = compareShootingAnalysis(previous, current);
