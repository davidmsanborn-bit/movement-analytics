  ...
  return (
    <main className="min-h-full pb-24 pt-20 md:pt-28">
      <PageSection className="text-center">
        ...
        <h1 className="mt-4 font-sans text-2xl font-semibold tracking-tight text-[var(--text-primary)] md:text-3xl">
        ...
        <p className="mt-8 text-xs text-[var(--text-tertiary)]">
          <Link href="/" className="text-[var(--text-secondary)] hover:text-[var(--text-tertiary)]">
            Back to home
          </Link>
        </p>
      </PageSection>
