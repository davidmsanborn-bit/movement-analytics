...
import { ProcessingShootingPageClient } from "@/components/analyze/ProcessingShootingPageClient";
...
export default function ShootingProcessingPage({ params }: Props) {
  const { id } = use(params);
