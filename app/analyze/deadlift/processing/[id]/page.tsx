...
import { ProcessingDeadliftPageClient } from "@/components/analyze/ProcessingDeadliftPageClient";
...
export default function DeadliftProcessingPage({ params }: Props) {
  const { id } = use(params);
